...
import './Project5_2.css'
import project4_1_img from './Chpt_5-Img/Project4_1Img.png'
    ...
    <div className="project-5_2-grid">
      ...
      <div className="description-5_2">
        <p>
          ...
          and deletion on both ends of the deque.
      ...
      <div className="project-5_2-insert-head">
        <pre>
          <code>
{`// DEQUE CLASS
...
public void insertHead(int data) {
  ...
  head = newNode;
      ...
      <div className="project-5_2-insert-tail">
        <pre>
          <code>
{`// DEQUE CLASS
...
public void insertTail(int data) {
  ...
  tail = newNode;
      ...
      <div className="project-5_2-delete-head">
        <pre>
          <code>
{`// DEQUE CLASS
...
public Node deleteHead() {
  ...
  return temp;
      ...
      <div className="project-5_2-delete-tail">
        <pre>
          <code>
{`// DEQUE CLASS
  ...
  return temp;
      ...
      <div className="project-5_2-insert-tail-exp">
        ...
        <p>
          ...
          <ul>
            ...
            <li>Otherwise, set tail.next equal to the new node and newNode.previous
                to the tail node.</li>
      ...
      <div className="project-5_2-delete-head-exp">
        <p>
          ...
          <br/>
          <ul>
            <li>Save a copy of the node containing the front value by calling the
                deleteHead method of the linked list class.</li>
        ...
        <p>
          ...
          <ul>
            ...
            <li>If head.next is null (head is the only node), set the tail node to null.</li>
            <li>Otherwise, set head.next.previous to null (head.next.previous =
                head).</li>
      ...
      <div className="project-5_2-delete-tail-exp">
        <p>
          ...
          <br/>
          <ul>
            <li>Save a copy of the node containing the last value by calling the
                deleteTail method of the linked list class.</li>
            <li>Return the saved node.</li>
          </ul>
        </p>
        <br/>
        <p>
          ...
          <ul>
            ...
            <li>If tail.previous is null (tail is the only node), set the head node to null.</li>
            <li>Otherwise, set tail.previous.next to null (tail.previous.next =
                tail).</li>
