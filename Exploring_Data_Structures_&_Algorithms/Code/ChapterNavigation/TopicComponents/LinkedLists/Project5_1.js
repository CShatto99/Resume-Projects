...
import './Project5_1.css'
import project5_1_img from './Chpt_5-Img/Project5_1Img.png'
  ...
  return (
    <div className="project-5_1-grid">
      ...
      <div className="description-5_1">
        <p>
          Project 5.1 is going to cover a minimal implementation of a
          linked list-based priority queue. The code that will be covered
          on this page includes insertion and deletion on a linked list
          and priority queue.
      ...
      <div className="project-5_1-requirements">
        ...
        <p>
           ...
           operation on the priority queue should remove the item with the smallest key.
        </p>
      </div>

      <div className="project-5_1-queue-insert">
        <pre>
          <code>
{`public void insert(int data) {
  ...
  list.listInsert(data);
      ...
      <div className="project-5_1-list-insert">
        <pre>
          <code>
{`public void listInsert(int value) {
  ...
  newNode.next = current;
      ...
      <div className="project-5_1-queue-remove">
        <pre>
          <code>
{`public int remove() {
  ...
  return temp.data;
      ...
      <div className="project-5_1-list-remove">
        <pre>
          <code>
  ...
  return temp;
      ...
      <div className="project-5_1-queue-insert-exp">
        <p>
          ...
          <br/>
          <ul>
            <li>Call the linked list insert method and pass the new data to it.</li>
          </ul>
        </p>
      </div>
      ...
      <div className="project-5_1-list-insert-exp">
        <p>
          ...
          <br/>
          <ul>
            <li>Declare all nodes required for a linked list insertion at a
                specified position.</li>
            <li>Check if the current node exists and the new node's data is greater
                than the current node's data.</li>
            <li>While the previous step is true, update previous to current and
                update current to the next node.</li>
          </ul>
          <b>Algorithm, part 2 (insertion)</b>
          <br/>
          <ul>
            <li>If the previous node remains null (list is empty), set head
            equal to the new node.</li>
      ...
      <div className="project-5_1-queue-remove-exp">
        <p>
          ...
          <br/>
          <ul>
            <li>Create a temporary copy of the smallest value using the linked list
                remove method.</li>
