...
import './Project5_3.css'
import project5_1_img from './Chpt_5-Img/Project4_1Img.png'
    ...
    <div className="project-5_3-grid">
      ...
      <div className="description-5_3">
        <p>
          ...
          list. It will cover two types of insertion, deletion of the first
          link and deletion with a specified key. You can
          view the complete project here: <a
            ...
            target="blank"> <i>Project 5.3</i>
          </a>.
        </p>
      </div>

      <div className="image-5_3">
        <img style={{width: '400px'}} src={project5_1_img} />
      </div>
      ...
      <div className="project-5_3-requirements">
        ...
        <p>
          ...
          which such a circular list is ideally suited.) Your list should
          handle insertion, searching, and deletion. You may find it convenient
          if these operations take place one link downstream of the link
          pointed to by current. (Because the upstream link is singly linked,
          you can’t get at it without going all the way around the circle.) You
          should also be able to display the list (although you’ll need to break
          the circle at some arbitrary point to print it on the screen). A
          step() method that moves current along to the next link might come in handy too.
        </p>
      </div>

      <div className="project-5_3-insert-first">
...
{`public void insertFirst(int data) {
  ...
  length++;
      ...
      <div className="project-5_3-delete-first">
        <pre>
          <code>
{`public Node deleteFirst() {
  ...
  return first;
      ...
      <div className="project-5_3-delete-after">
        <pre>
          <code>
{`public Node deleteAfter(int counter) {
  ...
  return temp;
      ...
      <div className="project-5_3-display">
        <pre>
          <code>
{`public void displayCircularList() {
  ...
  System.out.println();
      ...
      <div className="project-5_3-insert-first-exp">
        <p>
          <b>Function:</b> insert a node at the arbitrarily selected starting point in the
          ...
          <ul>
            ...
            <li>If last is null (list is empty), set last equal to the new node.</li>
            <li>Otherwise, set newNode.next equal to last.next (last.next = first).</li>
      ...
      <div className="project-5_3-delete-first-exp">
        <p>
          ...
          <br/>
          <ul>
            <li>Save a copy of the first node to be returned (last.next = first).</li>
            <li>If last is null (list is empty), return a null value.</li>
            <li>Otherwise, update first to the next node and update last.next to
                the new first node.</li>
            <li>Decrement the length of the list and return the copy of the first
                node.</li>
          </ul>
        </p>
      </div>
      ...
      <div className="project-5_3-delete-after-exp">
        <p>
          ...
          <ul>
            ...
            <li>While the loop has not terminated, update previous to current
                and current to the next node.</li>
          </ul>
      ...
      <div className="project-5_3-display-exp">
        <p>
          ...
          <ul>
            ...
            <li>While the previous step is true, display the current node and
                update current to the next node.</li>
