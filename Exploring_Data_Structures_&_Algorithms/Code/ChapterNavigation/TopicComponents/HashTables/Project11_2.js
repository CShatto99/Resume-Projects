...
import './Project11_2.css'
import project11_1_img from './Chpt_11-Img/Project4_1Img.png'

const Project11_2 = () => {
  let linearProbing = 'https://en.wikipedia.org/wiki/Linear_probing#targetText=Linear%20probing%20is%20a%20scheme,associated%20with%20a%20given%20key.'
  return (
    <div className="project-11_2-grid">
      ...
      <div className="description-11_2">
        <p>
        In project 11.2 we will see a hash table that will
        use <a href={linearProbing} target="blank"><i>linear probing</i></a> to
        store strings. On this page we will look at a hash function, an insert
        method, a delete method and a find method. You can
      ...
      <div className="project-11_2-hash">
...
{`public int hashFunc(String s) {
  ...
  return hashVal;
      ...
      <div className="project-11_2-insert">
        <pre>
          <code>
{`public void insert(DataItem newItem) {
  ...
  hashArray[hashVal] = newItem;
      ...
      <div className="project-11_2-delete">
        <pre>
          <code>
{`public DataItem delete(String key) {
  ...
  return null;
      ...
      <div className="project-11_2-find">
        <pre>
          <code>
{`public DataItem find(String key) {
  ...
  return null;
      ...
      <div className="project-11_2-hash-exp">
        <p>
          <b>Function:</b> map arbitrary strings to a fixed-size equal to the
          ...
          <ul>
            ...
            <li>Declare a For Loop that iterates over the entire string and in
            each iteration:
              <ul>
                <li>Get the character code of the current letter.</li>
                <li>Get the hash value by using a bit-manipulation formula with
                base 27.</li>
              </ul>
            </li>
      ...
      <div className="project-11_2-insert-exp">
        <p>
          ...
          <ul>
            ...
            <li>While the DataItem of the hash value index is not null and the
          ...
          <ul>
            ...
            <li>While the DataItem object of the hash value index exists:
              <ul>
                ...
                to be returned, set the data item to a nonItem (string is "*") and
                return the copy.</li>
      ...
      <div className="project-11_2-find-exp">
        <p>
          ...
          <ul>
            ...
            <li>While the DataItem object of the hash value index exists:
              <ul>
                <li>Check if the string attribute of the data item is equal to the
                key.</li>
