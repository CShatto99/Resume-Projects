    ...
    <div className="project-11_4-grid">
      ...
      <div className="description-11_4">
        <p>
          ...
          (percentage of array space taken) is greater than 50%. The rehash method
          will ultimately double the size of the initial array and re-write the
          contents to the new array. You can
      ...
      <div className="project-11_4-requirements">
        ...
        <p>
          ...
          twice as large whenever the load factor exceeds 0.5. The new array
          size should be a prime number. Refer to the section “Expanding the
          Array” in this chapter. Don’t forget you’ll need to handle items that
          have been “deleted,” that is, written over with –1.
        </p>
      </div>

      <div className="project-11_4-insert">
        <pre>
          <code>
{`public void insert(DataItem newItem) {
  ...
  numItems++;
      ...
      <div className="project-11_4-re-hash">
        <pre>
          <code>
{`public void rehash() {
  ...
  for(int i = 0; i < tempArray.length; i++) {
    ...
    if(tempArray[i] != null
      ...
      <div className="project-11_4-is-prime">
        <pre>
          <code>
  ...
  return true;
      ...
      <div className="project-11_4-insert-exp">
        <p>
          ...
          <br/>
          <ul>
            <li>Get the key of the new item and the hash value using this new key.</li>
            <li>Calculate the current load factor.</li>
            <li>If the load factor is greater than .5 (50%), call the rehash method.</li>
            <li>While the DataItem is not null and the key of the DataItem it not
            equal to -1:
              <ul>
            ...
            <li>Set the DataItem element of the new hash value equal to the new
            item.</li>
      ...
      <div className="project-11_4-re-hash-exp">
        <p>
          ...
          <ul>
            ...
            <li>For every item in the inital hash array:
              <ul>
                <li>Check if the DataItem is not null and the key of the DataItem
                is not equal to -1.</li>
                <li>If the previous condition is true, insert the DataItem into
                the new array.</li>
              </ul>
            </li>
          </ul>
      ...
      <div className="project-11_4-is-prime-exp">
        <p>
          ...
          <ul>
            ...
            <li>For every number up to the value of the square root (starting at 2):
              <ul>
                <li>Check if the value of the index evenly divides the given
                number.</li>
