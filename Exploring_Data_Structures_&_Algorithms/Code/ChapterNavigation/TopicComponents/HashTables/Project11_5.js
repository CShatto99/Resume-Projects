    ...
    <div className="project-11_5-grid">
      ...
      <div className="description-11_5">
        <p>
          ...
          due to its complexity but rather just insertion and finding items
          in a hash table and binary search tree. You can
      ...
      <div className="project-11_5-requirements">
        ...
        <p>
          ...
          11.3) as a starting point and the Tree class from the tree.java
          rogram (Listing 8.1) in Chapter 8. To display a small tree-based
          hash table, you could use an inorder traversal of each tree.
        </p>
        <br/>
        <p>
          Duplicates can present problems in both trees and hash tables, so
          add some code that prevents a duplicate key from being inserted in
          the hash table. (Beware: The find() method in Tree assumes a non-empty
      ...
      <div className="project-11_5-insert">
        <pre>
          <code>
{`public void insert(Node newNode) {
  ...
  hashArray[hashVal].insertBST(newNode);
      ...
      <div className="project-11_5-insert_BST">
        <pre>
          <code>
{`public void insertBST(Node newNode) {
  ...
  if(root == null)
    ...
    while(true) {
      ...
      <div className="project-11_5-find_BST">
        <pre>
          <code>
{`public Node findBST(int key) {
  ...
  return current;
      ...
      <div className="project-11_5-find">
        <pre>
          <code>
      ...
      <div className="project-11_5-insert-exp">
        <p>
          ...
          <ul>
            ...
            <li>Call the insert method on the DataItem of the hash value index
            using the new node.</li>
          </ul>
        </p>
      </div>
      ...
      <div className="project-11_5-find-exp">
        <p>
          ...
          <ul>
            ...
            <li>Get the node by calling the find method on the DataItem of
            the hash value index.</li>
      ...
      <div className="project-11_5-find_BST-exp">
        <p>
          ...
          <ul>
            ...
            <li>While the data of the current node is not equal to the key:
              <ul>
                <li>If the key is less than the data of the current node: set
                current to its left child.</li>
