  ...
  return (
    <div className="project-11_3-grid">
      ...
      <div className="description-11_3">
        <p>
          Project 11.3 will involve the implementation of
          a <a href={digitalFolding} target="blank"><i>digital folding</i></a>
          approach to a hash function of a linear probing hash table. This page
          will only be covering the solution method. You can
      ...
      <div className="project-11_3-requirements">
        ...
        <p>
          ...
          hash function (as described in the “Hash Functions” section of this
            ...
            may be easier than you think. Does it matter if the array size is
            not a multiple of 10?
        </p>
      </div>

      <div className="project-11_3-digital-fold">
        <pre>
          <code>
{`public int digitalFold(int k) {
  ...
  hashVal += Integer.parseInt(
    key.substring(groupPtr, key.length()));
  ...
  return (hashVal %= arraySize);
      ...
      <div className="project-11_3-digital-fold-exp">
        <p>
          ...
          <br/>
          <ul>
            <li>Convert the given key and the size of the array to a string
            and set the initial group to an empty string.</li>
            <li>Declare the group size, the initial hash value, a pointer for the
            current group and the number of groups.</li>
            <li>For every group in the string:
              <ul>
                <li>Check if the number of indexes left is greater than the group size.</li>
                <li>If the previous step is true: get a substring of integers of
                size "groupSize", convert the substring to an integer and add it
                to the hash value and increment the group pointer by the group size.</li>
              </ul>
            </li>
            <li>Create a substring with the remaining indices, parse the substring
            add it to the hash value.</li>
            <li>Reduce and return the hash value by taking hashVal modulo arraySize.</li>
          </ul>
        </p>
      </div>
