...
import './Project4_4.css'
import project4_4_img from './Chpt_4-Img/Project4_4Img.png'
  ...
  return (
    <div className="project-4_4-grid">
      ...
      <div className="image-4_4">
        <img style={{width: '300px'}} src={project4_4_img} />
      </div>
      ...
      <div className="project-4_4-insert">
        <pre>
          <code>
{`public void insert(long value) {
  ...
  if(nItems < maxSize)
    PQArray[nItems++] = value;
      ...
      <div className="project-4_4-remove">
        <pre>
          <code>
{`public long remove() {
  ...
  return PQArray[--nItems];
      ...
      <div className="project-4_4-display">
        <pre>
          <code>
{`public void display() {
