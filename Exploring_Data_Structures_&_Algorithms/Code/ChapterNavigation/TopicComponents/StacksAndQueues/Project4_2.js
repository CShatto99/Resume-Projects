...
import './Project4_2.css'
import project4_2_img from './Chpt_4-Img/Project4_2Img.png'
  ...
  return (
    <div className="project-4_2-grid">
      ...
      <div className="image-4_2">
        <img style={{width: '400px'}} src={project4_2_img} />
      </div>
      ...
      <div className="project-4_2-insert_rear">
        <pre>
          <code>
{`public void insertRear(long value) {
  ...
  arr[++rear] = value;
      ...
      <div className="project-4_2-insert_front">
        <pre>
          <code>
{`public void insertFront(long value) {
  ...
  arr[--front] = value;
      ...
      <div className="project-4_2-remove_rear">
        <pre>
          <code>
{`public long removeFront() {
  ...
  return currentFront;
      ...
      <div className="project-4_2-remove_front">
        <pre>
          <code>
