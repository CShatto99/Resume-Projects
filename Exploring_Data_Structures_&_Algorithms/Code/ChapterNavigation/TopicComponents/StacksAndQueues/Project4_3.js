...
import './Project4_3.css'
import project4_3_img from './Chpt_4-Img/Project4_3Img.png'
  ...
  return (
    <div className="project-4_3-grid">
      ...
      <div className="image-4_3">
        <img style={{width: '300px'}} src={project4_3_img} />
      </div>
      ...
      <div className="project-4_3-push_top">
        <pre>
          <code>
{`public void pushTop(long value) {
  ...
  arr[++top] = value;
      ...
      <div className="project-4_3-pop_top">
        <pre>
          <code>
{`public long popTop() {
  ...
  return arr[top--];
      ...
      <div className="project-4_3-push_bottom">
        <pre>
          <code>
{`public void pushBottom(long value) {
  ...
  arr[++bottom] = value;
      ...
      <div className="project-4_3-pop_bottom">
        <pre>
          <code>
