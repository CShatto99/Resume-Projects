...
import './Project12_3.css'
import project12_1_img from './Chpt_12-Img/Project12_3Img.png'
    ...
    <div className="project-12_3-grid">
      ...
      <div className="description-12_3">
        <p>
          ...
          minimum operations such as: inserting, deleting and peeking will
          be detailed on this page. The <b>trickleUp</b> and <b>trickleDown</b> methods
          will be identical to those in the previous projects. You can
          view the complete project here: <a
            ...
            target="blank"><i>Project 12.3</i>
          </a>.
        </p>
      </div>

      <div className="image-12_3">
        <img style={{width: '400px'}} src={project12_1_img} alt="Visual representation of a heap-based priority queue."/>
      </div>
      ...
      <div className="project-12_3-requirements">
        ...
        <p>
           ...
           (Listing 4.6) using a heap instead of an array. You should be able
           to use the Heap class in the heap.java program (Listing 12.1) without
           modification. Make it a descending queue (largest item is removed).
        </p>
      </div>

      <div className="project-12_3-insert">
        <pre>
          <code>
...
public boolean heapInsert(int key) {
  ...
  return true;
      ...
      <div className="project-12_3-remove">
        <pre>
          <code>
{`public int remove() {
...
public Node heapRemove() {
  ...
  return root;
      ...
      <div className="project-12_3-peek">
        <pre>
          <code>
{`public int peek() {
  ...
  return heapArray[0];
      ...
      <div className="project-12_3-insert-exp">
        <p>
          ...
          <br/>
          <ul>
            <li>If the current size if equal to the max size, the heap array is
            full, so return false.</li>
            <li>Create a new node with the given key.</li>
            <li>Insert the new node at the end of the heap array.</li>
            <li>Call the trickleUp method using the index of the newly inserted
            node and increment the current size by 1.</li>
      ...
      <div className="project-12_3-remove-exp">
        <p>
          ...
          <ul>
            ...
            <li>Call the heap remove method and return the key of the returned
            node.</li>
          </ul>
          <b>Algorithm, part 2 (Heap class)</b>
          <br/>
          <ul>
            ...
            <li>Set the root equal to the last node in the heap and decrement
            the number of items in the heap.</li>
            <li>Call the trickleDown method with the index of the replacement
            root (index 0).</li>
      ...
      <p>
        ...
        <br/>
        <ul>
          <li>Call the heap peek method and return the key of the returned
          node.</li>
        </ul>
        <b>Algorithm, part 2 (Heap class)</b>
        <br/>
