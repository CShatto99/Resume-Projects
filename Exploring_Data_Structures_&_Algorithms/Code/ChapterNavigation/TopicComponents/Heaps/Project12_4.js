...
import './Project12_4.css'
import project12_1_img from './Chpt_12-Img/Project12_4Img.png'
    ...
    <div className="project-12_4-grid">
      ...
      <div className="description-12_4">
        <p>
          ...
          support a priority queue. The <b>removeMax</b> and <b>findMax</b> methods
          in the BinaryTree class will by synonymous will the remove and peek
          methods that are in a traditional priority queue. You can
          view the complete project here: <a
            ...
            target="blank"><i>Project 12.4</i>
          </a>.
        </p>
      </div>

      <div className="image-12_4">
        <img style={{width: '400px'}} src={project12_1_img} alt="Visual representation of a binary search tree-based priority queue." />
      </div>
      ...
      <div className="project-12_4-requirements">
        ...
        <p>
           ...
           Modify this class so it supports priority queues by adding a removeMax()
           method that removes the largest item. In a heap this is easy, but in
           a tree it’s slightly harder. How do you find the largest item in a
           tree? Do you need to worry about both its children when you delete
           it? Implementing change() is optional. It’s easily handled in a
        ...
        <p>
           ...
           should be invisible to main() (except perhaps for displaying the
           tree while you’re debugging). Insertion and removeMax() will
           operate in O(logN) time.
        </p>
      </div>

      <div className="project-12_4-insert">
        <pre>
          <code>
...
public void insertBST(int data) {
  ...
  if(root == null)
    ...
    while(true) {
      ...
      <div className="project-12_4-remove">
        <pre>
          <code>
{`public int remove() {
...
public int removeMax() {
  ...
  return last.data;
      ...
      <div className="project-12_4-peek">
        <pre>
          <code>
{`public int peek() {
...
public int findMax() {
  ...
  return last.data;
        ...
        <ul>
          ...
          <li>Otherwise:
            <ul>
              ...
              <li>While a return statement is not encountered:
                <ul>
                  <li>Update parent to current.</li>
                  <li>If the data of the new node is less than the data of the
                  current node:
                    <ul>
                      <li>Update current to its left child.</li>
                      <li>If current is equal to null: set the left child of
                      the parent node equal to the new node.</li>
                      <li>Return to exit the While Loop.</li>
                    </ul>
                  </li>
                  <li>Otherwise, if the data of the new node is greater than
                  the data of the current node:
                    <ul>
                      <li>Update current to its right child.</li>
                      <li>If current is equal to null: set the right child of
                      the parent node equal to the new node.</li>
                      <li>Return to exit the While Loop.</li>
                    </ul>
                  </li>
      ...
      <div className="project-12_4-remove-exp">
        <p>
          <b>Function:</b> removes and returns the right-most node (largest item) from the
          binary search tree.
          <br/>
          <b>Algorithm, part 1 (PriorityQ class)</b>
          <br/>
          <ul>
            ...
            <li>Call the removeMax method of the BinaryTree class and return
            the data of the resulting node.</li>
          </ul>
          <b>Algorithm, part 2 (BinaryTree class)</b>
          <br/>
          <ul>
            <li>Initialize last to null and current to the root.</li>
            <li>While the current node exists:
              <ul>
      ...
      <div className="project-12_4-peek-exp">
        <p>
          ...
          <br/>
          <ul>
            <li>Call the findMax method of the BinaryTree class and return
            the data of the resulting node.</li>
          </ul>
          <b>Algorithm, part 2 (BinaryTree class)</b>
          <br/>
