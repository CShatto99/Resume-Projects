...
import './Project12_1.css'
import project12_1_img from './Chpt_12-Img/Project4_1Img.png'
    ...
    <div className="project-12_1-grid">
      ...
      <div className="description-12_1">
        <p>
          ...
          trickleDown). You can view the complete project here: <a
            ...
            target="blank"><i>Project 12.1</i>
          </a>.
        </p>
      </div>

      <div className="image-12_1">
        <img style={{width: '400px'}} src={project12_1_img} />
      </div>
      ...
      <div className="project-12_1-requirements">
        ...
        <p>
          ...
          ascending, rather than a descending, heap. (That is, the node at
          the root is the smallest rather than the largest.) Make sure all
          operations work correctly.
        </p>
      </div>

      <div className="project-12_1-insert">
        <pre>
          <code>
{`public boolean insert(int key) {
  ...
  return true;
      ...
      <div className="project-12_1-trickle-up">
        <pre>
          <code>
{`public void trickleUp(int index) {
  ...
  heapArray[index] = bottom;
      ...
      <div className="project-12_1-remove">
        <pre>
          <code>
{`public Node remove() {
  ...
  return root;
      ...
      <div className="project-12_1-trickle-down">
        <pre>
          <code>
  ...
  heapArray[index] = top;
      ...
      <div className="project-12_1-insert-exp">
        <p>
          ...
          <br/>
          <ul>
            <li>If the current size is equal to the max size (heap is full),
            return false.</li>
            <li>Create a new node with the given key.</li>
            <li>Add the new node to the heap array using the current size as the
            index.</li>
            <li>Call the trickleUp method with the currentSize index and increment
            the currentSize index.</li>
      ...
      <div className="project-12_1-trickle-up-exp">
        <p>
          <b>Function:</b> inserts a new node into the heap and trickles it up
          to the correct position.
          <br/>
          <b>Algorithm</b>
          <br/>
          <ul>
            <li>Declare the initial parent index and save a copy of the newly
            inserted node.</li>
            <li>While index exists (greater than 0) and the parent node is less than
            the bottom node:
              <ul>
      ...
      <div className="project-12_1-remove-exp">
        <p>
          ...
          <ul>
            ...
            <li>Replace the root with the last node in the heap and decrement
            the size of the heap.</li>
      ...
      <div className="project-12_1-trickle-down-exp">
        <p>
          ...
          <br/>
          <ul>
            <li>Declare the larger child variable and save a copy of the new
            top node.</li>
            <li>While the node has at least one child:
              <ul>
                <li>Initialize the indices of the left and right children.</li>
                <li>If the right child exists and the left child is less than
                the right child: set the right child to the larger child.</li>
                <li>Otherwise, set the left child to the larger child.</li>
                <li>If the value of the top node is greater than or equal to
                larger child: exit the While Loop.</li>
                <li>Move the new top node down by setting it equal to the
                larger child.</li>
                <li>Update the index to the larger child's index.</li>
              </ul>
            </li>
            <li>Update the original top node to its correct position in the heap.</li>
          </ul>
        </p>
      </div>
