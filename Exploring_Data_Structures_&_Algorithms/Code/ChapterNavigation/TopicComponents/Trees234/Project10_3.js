    ...
    <div className="project-10_3-grid">
      ...
      <div className="description-10_3">
        <p>
          ...
          return the sorted version using a selection sort. You can
      ...
      <div className="project-10_3-sort">
        <pre>
          <code>
    ...
    swap(dataItems, out, min);
      ...
      <div className="project-10_3-sort-exp">
        <p>
          ...
          <br/>
          <ul>
            <li>Delcare the inner index, the outer index and the min variable.</li>
            <li>Declare a For Loop that iterates over the entire array and
            perform the following in each iteration:
              <ul>
                <li>Set min equal to the starting element (out).</li>
                <li>Declare a For Loop that finds the minimum value of the
                remaining unsorted elements.</li>
