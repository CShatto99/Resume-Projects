...
import './Project6_4.css'
import project6_1_img from './Chpt_6-Img/Project4_1Img.png'
  ...
  return (
    <div className="project-6_4-grid">
      ...
      <div className="description-6_4">
        <p>
          In project 6.4 we will be looking at the classic <a
            href={knapsack} target="blank"><i>knapsack</i></a> problem. This
          page will include a knapsack method and a main method to demonstrate
          the functionality of the knapsack method. You can
          view the complete project here: <a
            ...
            target="blank"> <i>Project 6.4</i>
          </a>.
        </p>
      </div>

      <div className="image-6_4">
        <img style={{width: '400px'}} src={project6_1_img} />
      </div>
      ...
      <div className="project-6_4-requirements">
        ...
        <p>
          ...
          are the target weight and the array index where the remaining items start.
        </p>
      </div>

      <div className="project-6_4-knapsack">
        <pre>
          <code>
{`public static int knapsack(
  ...
  if(weights[index-1] > maxWeight)
    ...
    return Math.max(
      ...
      <div className="project-6_4-main">
        <pre>
          <code>
    ...
    knapsack(maxWeight, weights, values, size)
      ...
      <div className="project-6_4-knapsack-exp">
        <p>
          ...
          <br/>
          <ul>
            <li>If the current index equals 0 or the max weight of the knapsack
            is 0 (base case), the algorithm is complete so return 0.</li>
            <li>If the weight of the current index is greater than the max weight,
            it cannot be added to the knapsack so make a recursive call with a
            different index (index-1).</li>
            <li>Otherwise, return the maximum of two cases:
              <ol>
