...
const Project6_3 = () => {
  return (
    <div className="project-6_3-grid">
      ...
      <div className="project-6_3-power">
        <pre>
          <code>
{`public static int power(int x, int y) {
  ...
  if(y == 0)
    ...
    return (x * power(x, y-1));
      ...
      <div className="project-6_3-main">
        <pre>
          <code>
        ...
        <p>
          ...
          <ul>
            ...
            <li>Otherwise, print the current value of y and recursively call
                power with x and y-1 until y is equal to 0.</li>
          </ul>
        </p>
      </div>
