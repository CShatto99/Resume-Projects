  ...
  return (
    <div className="project-6_1-grid">
      ...
      <div className="description-6_1">
        <p>
          In project 6.1 we are going to be looking at a recursive approach to
          a method that performs multiplication on two integers. This page will
          cover the multiplication method and a main method to demonstrate the
          functionality of the project. You can view the complete project here: <a
      ...
      <div className="project-6_1-multiply">
        <pre>
          <code>
{`public static int mult(int x, int y) {
  ...
  if(x == 0 || y == 0)
    ...
    return (x + mult(x, y-1));
      ...
      <div className="project-6_1-main">
        <pre>
          <code>
  ...
  System.out.println(
    x + " times " + y + " = " + product
      ...
      <div className="project-6_1-multiply-exp">
        <p>
          <b>Function:</b> multiplies two arbitrary variables x and y together by adding
                          x to itself y times.
          <br/>
          <b>Algorithm</b>
          <br/>
          <ul>
            ...
            <li>If the previous step is true, trigger the series of returns by
            returning 0.</li>
            <li>Otherwise, print the current value of y and recursively call
                mult with x and y-1 until y is equal to 0.</li>
          </ul>
        </p>
      </div>
