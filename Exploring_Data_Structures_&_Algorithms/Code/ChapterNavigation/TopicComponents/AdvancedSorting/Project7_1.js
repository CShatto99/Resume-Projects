  ...
  return (
    <div className="project-7_1-grid">
      ...
      <div className="description-7_1">
        <p>
          In project 7.1 we will be looking at the implementation of a method that
          performs a <a href={partitionProb} target="blank"><i>partition</i></a> on
          an array of integers. This project will cover the partition method, a
          helper method named <b>manualSort</b> and a helper method named <b>swap</b>.
      ...
      <div className="project-7_1-partition">
...
{`public void partitionIt(int left, int right) {
  ...
  swap(leftPtr, right);
      ...
      <div className="project-7_1-manual-sort">
        <pre>
          <code>
{`public void manualSort(int left, int right) {
  ...
  if(size() == 2 && arr[left] > arr[right])
    ...
    if(arr[right-1] > arr[right])
      ...
      <div className="project-7_1-swap">
        <pre>
          <code>
  ...
  arr[b] = temp;
      ...
      <div className="project-7_1-partition-exp">
        <p>
          ...
          <br/>
          <ul>
            <li>If the size of the array is less than or equal to 3, call the
            manualSort method with the first and last elements of the array.</li>
            <li>Declare the left pointer and the pivot.</li>
            <li>Declare a For Loop that iterates over the entire array.</li>
            <li>In each iteration of the loop, check if the current element is
            less than the pivot.</li>
            <li>If the previous condition is true, swap the index of the current
            element with the left pointer and increment the left pointer.</li>
      ...
      <div className="project-7_1-manual-sort-exp">
        <p>
          ...
          <ul>
            ...
            <li>If the array is of size 2 and the left element is greater that
            the right element, swap them.</li>
            <li>If the previous 2 steps are false and the left element is greater
            than the middle element, swap them.</li>
            <li>If the previous 2 steps are false and the left element is greater
            than the right element, swap them.</li>
            <li>If the previous 2 steps are false and the middle element is greater
            than the right element, swap them.</li>
          </ul>
        </p>
      </div>
